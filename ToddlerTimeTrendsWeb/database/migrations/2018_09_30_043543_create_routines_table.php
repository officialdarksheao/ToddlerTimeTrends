...
class CreateRoutinesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('routines', function (Blueprint $table) {
            ...
            $table->integer('task_type')->comment('Integer matching up to a constants file of types of things that can be scheduled on a regular basis.');
            $table->integer('task_id')->comment('Optional field if there is a specific item that is tracked, for instance a specific food or medication. For medication this differs from prescription reminders as this is for specific time in a Kiddos routine that medications are taken.');
